 ...
 *   5. Comprehension (5)
 *
 * Randomization happens WITHIN each section only.
 * Each question is tagged with `section` and `sectionName`.
 */
const buildQuestionPaper = (lang) => {
  ...
  // 1) Math — 20 (shuffled within math bank)
  ...
  // 2) Reasoning — 20 (shuffled within reasoning bank)
  ...
  // 3) GK — 25 (shuffled within GK bank)
  ...
  // 4) English — 20 (shuffled within English bank)
  ...
  // Concatenate in FIXED order — NOT shuffled across sections
